...
/**
 * <p>
 * use stanford nlp to recognize nouns and retrieve them in the given gene name databases. the
 * strings in database are stored in hashset.
 * </p>
 * */
public class TokenAnnotator extends JCasAnnotator_ImplBase {
  private static BufferedReader in = null;
private PosTagNamedEntityRecognizer Tagger=null;
  ...
  /**
   * <p>
   * read the database and store them in hashset
   * </p>
   * 
   * @param aContext
   * */
  public void initialize(UimaContext aContext) throws ResourceInitializationException {
    ...
    input = (String) aContext.getConfigParameterValue("GENE_FILE");
    InputStream is = GeneReader.class.getClassLoader().getResourceAsStream(input);
  ...
  /**
   * use stanford nlp to recognize nouns and retrieve them in the given gene name databases. Store
   * the recognized terms into Token, and each confidence is assigned to 1.0, and its casProcessId
   * is TokenAnnotator.
   * 
   * @param aJCas
   * */
