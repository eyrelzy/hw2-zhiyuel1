...
public class AGene extends Gene {
  ...
  public final static int typeIndexID = JCasRegistry.register(AGene.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected AGene() {/* intentionally empty block */}
   ...
   */
  public AGene(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public AGene(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
